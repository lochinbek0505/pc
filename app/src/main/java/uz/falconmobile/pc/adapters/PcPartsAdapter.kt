...
class PcPartsAdapter(
    var  context: Context,
    private val items: List<main_model>,
    val listener: ItemSelectListener
) : RecyclerView.Adapter<PcPartsAdapter.PcPartViewHolder>() {

    interface ItemSelectListener {

        fun onClick(date: main_model)
    ...
    class PcPartViewHolder(private val binding: ItemLayoutBinding) :
        ...
        fun bind(pcPart: main_model) {
            binding.ilTvName.text = pcPart.hardware_name
        }
    }
